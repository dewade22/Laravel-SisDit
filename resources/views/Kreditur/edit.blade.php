    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                <form action="{{route('Krediturs.update', $kreditur->Id_Kreditur)}}" method="POST">
                    {{csrf_field()}}
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" id="Nama_Kreditur" name="Nama_Kreditur" value="{{$kreditur->Nama_Kreditur}}" required>
                                    <label class="form-label">Nama Kreditur</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" id="Tempat_Lahir" name="Tempat_Lahir" value="{{$kreditur->Tempat_Lahir}}" required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" id="Pekerjaan" name="Pekerjaan" value="{{$kreditur->Pekerjaan}}" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" class="form-control" id="Telepon" name="Telepon" value="{{$kreditur->Telepon}}" required>
                                    <label class="form-label">Telepon</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea style="height:150px" class="form-control" id="Alamat" name="Alamat" required>{{$kreditur->Alamat}}</textarea>
                                    <label class="form-label">Alamat</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" class="form-control" id="No_KTP" name="No_KTP" value="{{$kreditur->No_KTP}}" required>
